...
KUKA_7DOF_THREE_FINGER_RIGHT_ARM_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"/workspace/isaaclab/source/usd/assemble_right_hand_robot3/assemble_robot_with_tip_collision.usd",
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        pos=(-0.05175, 0.06526, 1.45653),
        rot=(-0.00072, 0.00124, 0.64281, 0.76603),
        joint_pos={
            "joint1": 0.0,
            "joint2": -1.5708,
            "joint3": -1.396,
