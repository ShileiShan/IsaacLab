...
class SoccerEnvCfg(DirectRLEnvCfg):
    ...
    scene: InteractiveSceneCfg = InteractiveSceneCfg(num_envs=256, env_spacing=22.0, replicate_physics=True)

    # reset
    max_ball_pos = [11.0, 7.0]
...
class SoccerEnv(DirectRLEnv):
    ...
    def _apply_action(self) -> None:
        self.carter.set_joint_effort_target(self.actions, joint_ids=[self._left_dof_idx[0], self._right_dof_idx[0]])
