...
# Pre-defined configs
##
from isaaclab_assets import KUKA_SELF_THREE_FINGER_CFG
...
def design_scene() -> tuple[dict, list[list[float]]]:
    ...
    # -- Robot
    robot_cfg = KUKA_SELF_THREE_FINGER_CFG.replace(prim_path="/World/Origin1/Robot")
...
def run_simulator(sim: sim_utils.SimulationContext, entities: dict[str, Articulation], origins: torch.Tensor):
    ...
    finger_joint_indices = [i for i, name in enumerate(joint_names) if "finger" in name]
